...
<div class="swal" data-swal="<?= session()->get('pesan') ?>"></div>
    ...
    <a href="/fasilitas_in/detail_fasilitas_in/<?= $fasilitas_in['trn_id'] ?>" class="btn btn-success mb-3 ml-3" >Kembali ke Detail</a>
<form action="/fasilitas_in_det/save_detail/" method="post">
<?= csrf_field() ?>
<input type="text" name="id" value="<?= $fasilitas_in_det['id'] ?>">
    <div class="row">
        <div class="col">
        <label for="" class="d-inline"> Nomor Dokumen </label>
        <input type="text" class="form-control d-inline" value="<?= $fasilitas_in['trn_no'] ?>" readonly name="trn_id">
        <input type="hidden" class="form-control d-inline" value="<?= $fasilitas_in['trn_id'] ?>" readonly name="trn_id">
        ...
        <input type="text" class="form-control d-inline" value="" name="qty">
        <div class="invalid-feedback">
    ...
    <div class="row">
        ...
        <input type="text" class="form-control d-inline" value="" name="kegunaan">
        <div class="invalid-feedback">
