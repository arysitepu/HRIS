...
<div class="card-body col">
  <a href="/contact_employee/index" class="btn btn-success ">Kembali ke table</a><br>
</div>
<div class="card-body">
...
<input type="hidden" name="id" value="<?= $contact['id'] ?>">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <select id="" class="selField form-control <?=   ($validation->hasError('jenis_kelamin')) ? 'is-invalid' : '' ?>" name="jenis_kelamin" value="">
  ...
  <button type="submit" class="btn btn-primary"> <i class="fas fa-edit"></i> Ubah data</button>
</form>
</div>
</div>
